...
public:
    WEBCORE_EXPORT static Ref<Frame> create(Page*, HTMLFrameOwnerElement*, std::weak_ptr<FrameLoaderClient>);
...
protected:
    Frame(Page&, HTMLFrameOwnerElement*, std::weak_ptr<FrameLoaderClient>);
